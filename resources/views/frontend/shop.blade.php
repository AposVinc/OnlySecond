                            ...
                            <div class="item">
                                <div class="product-thumb clearfix mb_30">
                                    ...
                                    <div class="caption product-detail text-center">
                                        <h6 data-name="product_name" class="product-name mt_20"><a href="#" title="Casual Shirt With Ruffle Hem">{{$product->collection->brand->name}} {{$product->collection->name}} {{$product->color}}</a></h6>
                    ...
                    <div class="col-sm-12">
                        <div class="brand owl-carousel ptb_20">
                            @foreach($brands as $brand)
                                <div class="item text-center"> <a href="#"><img src="images/brand/brand1.png" alt="{{$brand->name}}" class="img-responsive" /></a> </div>
                            @endforeach
                        </div>
                    </div>
                </div>
