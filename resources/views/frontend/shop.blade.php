                            ...
                            <div class="item">
                                <div class="product-thumb clearfix mb_30">
                                    ...
                                    <div class="caption product-detail text-center">
                                        <h6 data-name="product_name" class="product-name mt_20"><a href="#" title="Casual Shirt With Ruffle Hem">{{$product->collection->brand->name}} {{$product->collection->name}}, {{$product->color->name}}</a></h6>
