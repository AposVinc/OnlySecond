                ...
                <div id="listProducts" class="row">
                    @foreach($products as $product)
                        @if($product->offer()->exists())
                            <div class="product-layout product-grid col-md-4 col-xs-6 " brand="{{$product->collection->brand->id}}" collection="{{$product->collection->id}}" color="{{$product->color->hex}}" material="{{$product->specification->material}}" price="{{$product->offer->calculateDiscount()}}" genre="{{$product->genre}}" rate="{{$product->offer->rate}}">
                                <div class="item">
                        ...
                        @else
                            <div class="product-layout product-grid col-md-4 col-xs-6" brand="{{$product->collection->brand->id}}" collection="{{$product->collection->id}}" color="{{$product->color->hex}}" material="{{$product->specification->material}}" price="{{$product->price}}" genre="{{$product->genre}}" rate="">
                                <div class="item">
                                    <div class="product-thumb clearfix mb_50">
                                        <div class="image product-imageblock">
                                            <a href="{{route('Product', ['cod' => $product->cod])}}">
