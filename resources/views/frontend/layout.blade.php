...
@if(strpos(route::currentRouteName(),'Shop')!== false or strpos(route::currentRouteName(),'Discount')!== false )
    ...
    <script>
        ...
        $("#input-sort").change(function() {
            ...
            var price_range = $('#amount')[0].value;
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    rates_checked: arrRatesChecked,
                    genres_checked: arrGenresChecked,
                    brands_checked: arrBrandsChecked,
                    collections_checked: arrCollectionsChecked,
                    categories_checked: arrCategoriesChecked,
                    colors_checked: arrColorsChecked,
                    materials_checked: arrMaterialsChecked
                },
                /*
