...
@if(strpos(route::currentRouteName(),'EditProfile')!== false)
    <script src="{{ URL::asset('js/frontend/custom/editProfile.js') }}"></script>
@endif

@if(strpos(route::currentRouteName(),'Address')!== false)
    <!-- checkout nuovo indirizzo -->
    <script src="{{ URL::asset('js/frontend/custom/address.js') }}"></script>

@endif

@if(strpos(route::currentRouteName(),'Payment')!== false)
    <script src="{{ URL::asset('js/frontend/custom/payment.js') }}"></script>
@endif

@if(strpos(route::currentRouteName(),'Checkout')!== false)
    <script src="{{ URL::asset('js/frontend/custom/checkout.js') }}"></script>
@endif
...
@if(strpos(route::currentRouteName(),'Shop')!== false or strpos(route::currentRouteName(),'Discount')!== false )
    ...
    <script>
        $(function() {
            ...
            $("#slider-range").slider({
                ...
                min: 0,
                max: 800,
                values: [minprice || 0, maxprice || 800],
    ...
    <script src="{{ URL::asset('js/frontend/custom/filter.js') }}"></script>
