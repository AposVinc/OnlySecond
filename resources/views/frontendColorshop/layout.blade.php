...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset("css/frontendColo/bootstrap4/bootstrap.min.css")}}">
    <link href="{{URL::asset("plugins/frontendColo/font-awesome-4.7.0/css/font-awesome.min.css")}}" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="{{URL::asset("plugins/frontendColo/OwlCarousel2-2.2.1/owl.carousel.css")}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset("plugins/frontendColo/OwlCarousel2-2.2.1/owl.theme.default.css")}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset("plugins/frontendColo/OwlCarousel2-2.2.1/animate.css")}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset("css/frontendColo/main_styles.css")}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset("css/frontendColo/responsive.css")}}">
<!-- css pagina contatti-->
    <link rel="stylesheet" href="{{URL::asset("plugins/frontendColo/themify-icons/themify-icons.css")}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset("plugins/frontendColo/jquery-ui-1.12.1.custom/jquery-ui.css")}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset("css/frontendColo/contact_styles.css")}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset("css/frontendColo/contact_responsive.css")}}">
</head>
...
<script src="{{URL::asset("plugins/frontendColo/OwlCarousel2-2.2.1/owl.carousel.js")}}"></script>
<script src="{{URL::asset("plugins/frontendColo/easing/easing.js")}}"></script>
<script src="{{URL::asset("js/frontendColo/bootstrap4/custom.js")}}"></script>
...
<script src="{{URL::asset("plugins/frontendColo/jquery-ui-1.12.1.custom/jquery-ui.js")}}"></script>
<script src="{{URL::asset("js/frontendColo/contact_custom.js")}}"></script>
</body>
