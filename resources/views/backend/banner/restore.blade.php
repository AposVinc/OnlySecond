...
@section('content')
    ...
    <form action="{{route('Admin.Banner.RestorePost')}}" method="post" class="form-horizontal">
        @csrf
        ...
        <div class="card add">
            <div class="card-body card-block">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select name="collection" id="collection" class="form-control" onchange="GetBannerRestore()" required>
