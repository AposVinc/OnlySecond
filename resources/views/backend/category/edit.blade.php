        ...
        <div class="card add">
            <div class="card-body card-block">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input value="" type="text" id="text-input newname" name="newname" placeholder="Inserisci il nuovo nome della categoria" class="form-control"required>
                    </div>
                </div>
            </div>
